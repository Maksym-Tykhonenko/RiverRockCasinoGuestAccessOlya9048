...
const [route, setRoute] = useState(false);
  ...
  //const initialUrlRef = useRef('https://safe-hub-hub.top/');
//
  //const [INITIAL_URL, setInitialUrl] = useState(
  //  'https://safe-hub-hub.top/',
  //);
...
useEffect(() => {
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        <Stack.Screen name="Main" component={AppRootMainNavigation} />
      </Stack.Navigator>
    );
  };
  ...
  return (
    <NavigationContainer>
      {!isLoading ? <SplashScreen /> : <Route isFatch={route} />}
    </NavigationContainer>
  );
};


const AppRootMainNavigation = () => {
